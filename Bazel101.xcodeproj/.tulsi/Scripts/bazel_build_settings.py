...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_nghianguyen/26174b88929a7519cb39e02da1a5e3d1/execroot/__main__',
    '/private/var/tmp/_bazel_nghianguyen/26174b88929a7519cb39e02da1a5e3d1',
    'ios_x86_64',
    {
        'watchos_arm64_32': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/nghianguyen/Library/Application Support/Tulsi/0.20220209.88/Bazel',
